...
public class InheritanceActivity {
    ...
    public static void main(String[] args) {
        ...
        p.setAge(21);
        Person_I pWithParams = new Person_I("Aleksey", 33);
        ...
        System.out.println("-----------------------------");
        System.out.println("Parametrized person name is : " + pWithParams.getName());
        System.out.println("Parametrized person age is  : " + pWithParams.getAge());
